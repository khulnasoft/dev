...
| `@nextauth.js/sveltekit`         | `1.0.2`         |                                             |
| `@nextauth.js/prisma-adapter`    | `1.3.3`         | [Docs](/getting-started/adapters/prisma)    |
| `@nextauth.js/unstorage-adapter` | `2.1.0`         | [Docs](/getting-started/adapters/unstorage) |
| `@nextauth.js/drizzle-adapter`   | `1.1.1`         | [Docs](/getting-started/adapters/drizzle)   |
...
If you're using the built-in NextAuth.js pages, then you are good to go now! Navigating to your `/signin` route should include a "Signin with Passkeys" button now.
