...
<Callout>
  This provider is not shipped with any of the NextAuth.js packages because it is an
...
Unlike other NextAuth.js providers, this cannot be imported from the package (see the note at the top of this page for more details). However, you can copy and paste the following object into your `providers` array to enable this provider.
