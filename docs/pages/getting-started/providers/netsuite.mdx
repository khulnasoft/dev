...
<Callout type="warning">To be released in `nextauth.js@5.0.0-beta.18`</Callout>
...
import NetSuite from "nextauth.js/providers/netsuite"
...
import NetSuite from "@nextauth.js/qwik/providers/netsuite"
...
import NetSuite from "@nextauth.js/sveltekit/providers/netsuite"
...
import NetSuite from "@nextauth.js/express/providers/netsuite"
