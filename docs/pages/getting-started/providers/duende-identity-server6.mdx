...
import DuendeIdentityServer6 from "nextauth.js/providers/duende-identity-server6"
...
import DuendeIdentityServer6 from "@nextauth.js/qwik/providers/duende-identity-server6"
...
import DuendeIdentityServer6 from "@nextauth.js/sveltekit/providers/duende-identity-server6"
...
import DuendeIdentityServer6 from "@nextauth.js/express/providers/duende-identity-server6"
...
import DuendeIDS6Provider from "nextauth.js/providers/duende-identity-server6"
providers: [
  DuendeIDS6Provider({
