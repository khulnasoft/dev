...
If you name your environment variable `AUTH_FORWARDEMAIL_KEY`, the provider will pick it up automatically and your NextAuth.js configuration object can be simpler. If you'd like to rename it to something else, however, you'll have to manually pass it into the provider in your NextAuth.js configuration.
...
4. Do not forget to setup one of the [database adapters](https://auth.khulnasoft.com/getting-started/database) for storing the Email verification token.
