...
If you name your environment variable `AUTH_SENDGRID_KEY`, the provider will pick it up automatically and your NextAuth.js configuration object can be simpler. If you'd like to rename it to something else, however, you'll have to manually pass it into the provider in your NextAuth.js configuration.
