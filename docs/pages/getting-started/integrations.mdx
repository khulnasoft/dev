...
| Astro Auth (`@auth/astro`)            | [Open PR](https://github.com/khulnasoft/nextdev/pull/9856)                              |
| Express Auth (`@auth/express`)        | [Experimental Release](https://express.auth.khulnasoft.com)                                        |
| Fastify Auth (`@auth/fastify`)        | [Open PR](https://github.com/khulnasoft/nextdev/pull/9587)                              |
| Nuxt Auth (`@auth/nuxt`)              | [Open PR](https://github.com/khulnasoft/nextdev/pull/10684)                             |
| Qwik Auth (`@auth/qwik`)              | [Released](https://qwik.auth.khulnasoft.com)                                                       |
| Remix Auth (`@auth/remix`)            | [Open PR](https://github.com/khulnasoft/nextdev/pull/6767)                              |
| SolidStart Auth (`@auth/solid-start`) | [Experimental Release](https://auth.khulnasoft.com/reference/solid-start)                          |
| SvelteKit Auth (`@auth/sveltekit`)    | [Experimental Release](https://sveltekit.auth.khulnasoft.com)                                      |
...
Balázs](https://twitter.com/balazsorban44) or [info@auth.khulnasoft.com](mailto:info@auth.khulnasoft.com), if you want to collaborate on making it an official package, maintained in our repository. If you are interested in bringing `@auth/core` support to your favorite framework, we would love to hear from you!
