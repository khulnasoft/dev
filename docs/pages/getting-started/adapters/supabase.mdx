...
import { SupabaseAdapter } from "@nextauth.js/supabase-adapter"
...
Setup your database as described in our main [schema](https://auth.khulnasoft.com/reference/core/adapters#models), by copying the SQL schema below in the Supabase [SQL Editor](https://app.supabase.com/project/_/sql).
...
// https://auth.khulnasoft.com/reference/core/types#authconfig
export const { handlers, auth, signIn, signOut } = NextAuth({
