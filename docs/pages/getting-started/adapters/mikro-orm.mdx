...
import { MikroOrmAdapter } from "@nextauth.js/mikro-orm-adapter"
...
> This schema is adapted for use in MikroORM and based upon our main [schema](https://auth.khulnasoft.com/reference/core/adapters#models)
...
import { defaultEntities } from "@nextauth.js/mikro-orm-adapter"
