...
import { KyselyAdapter } from "@nextauth.js/kysely-adapter"
import { db } from "../../../db"
...
// that the database interface has all the fields that NextAuth.js expects.
import { KyselyAuth } from "@nextauth.js/kysely-adapter"
...
```ts
import type { Codegen } from "@nextauth.js/kysely-adapter"
