...
import { Neo4jAdapter } from "@nextauth.js/neo4j-adapter"
...
This schema is adapted for use in Neo4j and is based upon our main [models](https://auth.khulnasoft.com/reference/core/adapters#models). Please check there for the node properties. Relationships have no properties.
