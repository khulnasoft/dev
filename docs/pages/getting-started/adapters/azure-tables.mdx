...
```bash npm2yarn
npm install @nextauth.js/azure-tables-adapter
```
...
```ts filename="./auth.ts"
import NextAuth, { type AuthConfig } from "nextauth.js"
import { TableStorageAdapter } from "@nextauth.js/azure-tables-adapter"
...
import SvelteKitAuth, { type AuthConfig } from "@nextauth.js/sveltekit"
import { TableStorageAdapter } from "@nextauth.js/azure-tables-adapter"
import { AzureNamedKeyCredential, TableClient } from "@azure/data-tables"
...
import ExpressAuth, { type AuthConfig } from "@nextauth.js/express"
import { TableStorageAdapter } from "@nextauth.js/azure-tables-adapter"
import { AzureNamedKeyCredential, TableClient } from "@azure/data-tables"
