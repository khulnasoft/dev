...
```bash npm2yarn
npm install @nextauth.js/dynamodb-adapter @aws-sdk/lib-dynamodb @aws-sdk/client-dynamodb
```
...
import { DynamoDBAdapter } from "@nextauth.js/dynamodb-adapter"
