...
```bash npm2yarn
npm install @nextauth.js/dgraph-adapter
```
...
import { DgraphAdapter } from "@nextauth.js/dgraph-adapter"
...
> This schema is adapted for use in Dgraph and based upon our main [schema](https://auth.khulnasoft.com/reference/core/adapters)
