...
import { D1Adapter } from "@nextauth.js/d1-adapter"
...
```javascript
import { up } from "@nextauth.js/d1-adapter"
...
- You can also initialize your tables manually. Look in [migrations.ts](https://github.com/khulnasoft/nextdev/blob/main/packages/adapter-d1/src/migrations.ts) for the relevant SQL as well as an example of the `up()` function from above.
