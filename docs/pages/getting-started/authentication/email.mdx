...
<Callout>
  ...
  you choose, you **must still configure a database** so that NextAuth.js can save
...
NextAuth.js will automatically pick up these if formatted like the example above.
...
Let’s enable `ForwardEmail` as a sign in option in our NextAuth.js configuration. You’ll have to import the `ForwardEmail` provider from the package and pass it to the providers array we setup earlier in the NextAuth.js config file:
...
import ForwardEmail from "nextauth.js/providers/forwardemail"
...
import ForwardEmail from "@nextauth.js/qwik/providers/forwardemail"
...
import ForwardEmail from "@nextauth.js/sveltekit/providers/forwardemail"
...
Let’s enable `Resend` as a sign in option in our NextAuth.js configuration. You’ll have to import the `Resend` provider from the package and pass it to the providers array we setup earlier in the NextAuth.js config file:
...
```ts filename="/src/routes/plugin@auth.ts"
import { QwikAuth$ } from "@nextauth.js/qwik"
import Resend from "@nextauth.js/qwik/providers/resend"
...
```ts filename="./src/auth.ts"
import SvelteKitAuth from "@nextauth.js/sveltekit"
import Resend from "@nextauth.js/sveltekit/providers/resend"
...
Let’s enable `Sendgrid` as a sign in option in our NextAuth.js configuration. You’ll have to import the `Sendgrid` provider from the package and pass it to the providers array we setup earlier in the NextAuth.js config file:
...
```ts filename="/src/routes/plugin@auth.ts"
import { QwikAuth$ } from "@nextauth.js/qwik"
import Sendgrid from "@nextauth.js/qwik/providers/sendgrid"
...
```ts filename="./src/auth.ts"
import SvelteKitAuth from "@nextauth.js/sveltekit"
import Sendgrid from "@nextauth.js/sveltekit/providers/sendgrid"
...
NextAuth.js does not include `nodemailer` as a dependency, so you'll need to install it yourself if you want to use the Nodemailer provider.
...
```ts filename="./auth.ts"
import NextAuth from "nextauth.js"
import Nodemailer from "nextauth.js/providers/nodemailer"
...
```ts filename="/src/routes/plugin@auth.ts"
import { QwikAuth$ } from "@nextauth.js/qwik"
import Nodemailer from "@nextauth.js/qwik/providers/nodemailer"
...
```ts filename="./src/auth.ts"
import SvelteKitAuth from "@nextauth.js/sveltekit"
import Nodemailer from "@nextauth.js/sveltekit/providers/nodemailer"
...
Next, we can add a sign in button somewhere in your application like the Navbar. This will forward the user on to the NextAuth.js default signin page.
...
Start your application, click on the sign in button we just added, and you should see NextAuth.js built-in sign in page with the option to sign in with your email:

<Screenshot src={MagicLink} alt="Screenshot of sign in page" />

Insert your email and click "Sign in with Email". You should receive an email from NextAuth.js, click on it and should be redirected to your application, landing already authenticated.
...
Let’s enable `Postmark` as a sign in option in our NextAuth.js configuration. You’ll have to import the `Postmark` provider from the package and pass it to the providers array we setup earlier in the NextAuth.js config file:
...
```ts filename="./auth.ts"
import NextAuth from "nextauth.js"
import Postmark from "nextauth.js/providers/postmark"
...
```ts filename="/src/routes/plugin@auth.ts"
import { QwikAuth$ } from "@nextauth.js/qwik"
import Postmark from "@nextauth.js/qwik/providers/postmark"
...
```ts filename="./src/auth.ts"
import SvelteKitAuth from "@nextauth.js/sveltekit"
import Postmark from "@nextauth.js/sveltekit/providers/postmark"
...
You should name the key something that makes sense to you, like "NextAuth.js".
...
Let's enable `Loops` as a sign-in option for our NextAuth.js configuration. You'll have to import the `Loops` provider from the package and pass it to the providers array we set up earlier in the NextAuth.js config file:
...
```ts filename="./auth.ts"
import NextAuth from "nextauth.js"
import Loops from "nextauth.js/providers/loops"
...
```ts filename="./src/auth.ts"
import SvelteKitAuth from "@nextauth.js/sveltekit"
import Loops from "@nextauth.js/sveltekit/providers/loops"
import {
  AUTH_LOOPS_KEY,
...
Start your application, click on the signin button we just added, and you should see NextAuth.js built-in sign in page with the option to sign in with your email.
...
Let’s enable `Mailgun` as a sign in option in our NextAuth.js configuration.
You’ll have to import the `Mailgun` provider from the package and pass it to the providers array we setup earlier in the NextAuth.js config file:
...
```ts filename="./auth.ts"
import NextAuth from "nextauth.js"
import Mailgun from "nextauth.js/providers/mailgun"
...
```ts filename="/src/routes/plugin@auth.ts"
import { QwikAuth$ } from "@nextauth.js/qwik"
import Mailgun from "@nextauth.js/qwik/providers/mailgun"
...
```ts filename="./src/auth.ts"
import SvelteKitAuth from "@nextauth.js/sveltekit"
import Mailgun from "@nextauth.js/sveltekit/providers/mailgun"
