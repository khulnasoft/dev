...
If you want to create a new official framework integration and distribute it under `@nextauth.js/` namespace, please make sure to follow the next steps and fulfill our maintenance requirements below:
