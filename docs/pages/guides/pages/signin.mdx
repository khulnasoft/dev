...
To add a custom sign-in page, you'll need to define the path to your page in the [`pages`](/reference/core/types#pagesoptions) object in your NextAuth.js configuration. Make sure a route / page actually exists at the path you're defining here!
...
import Credentials from "@nextauth.js/qwik/providers/credentials"
...
import type { Provider } from "@nextauth.js/sveltekit/providers"
