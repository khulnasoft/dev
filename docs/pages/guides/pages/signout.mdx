...
Is easy to configure NextAuth.js to display a custom sign out page in case you need it.

Here's the code for a simple sign out page built on top of the [example app](https://github.com/khulnasoft/nextdev-example):
