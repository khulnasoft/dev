...
For this tutorial, we're gonna use the default [Auth.js & Next.js example app](https://github.com/khulnasoft/nextdev-example). If you already have an existing Next.js app, it should work too. If you don't, clone the repository:
