...
Auth.js adapters allow you to integrate with any (even multiple) database/back-end service, even if we don't have an [official package](https://github.com/khulnasoft/nextdev/tree/main/packages) available yet. (We welcome PRs for new adapters! See the [guidelines](#official-adapter-guidelines) below.)
...
Optionally, you can run our [Adapter tests](https://github.com/khulnasoft/nextdev/blob/main/packages/utils/adapter.ts) on your adapter to ensure it is compliant with the Auth.js.
