...
NextAuth.js libraries allow you to restrict users by intercepting the registration/login flow. You can use the `signIn` callback to control whether a user is allowed to sign up or not.
...
Add the following code to your NextAuth.js configuration:
