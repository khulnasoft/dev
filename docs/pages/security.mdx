...
<Callout>
  `@nextauth.js/*` packages (other than the database adapters) are currently
  under development and - unless stated otherwise - they are not considered
  ready for production yet. That said, we encourage you to reach out to us if
  you have any questions or concerns via the below-mentioned channels. We are
  committed to making NextAuth.js a secure and reliable solution for your
...
NextAuth.js practices responsible disclosure. We request that you contact us directly to report serious issues that might impact the security of sites using NextAuth.js.
...
The best way to report an issue is by contacting us via email at info@khulnasoft.com, dev.sulaiman@icloud.com,
