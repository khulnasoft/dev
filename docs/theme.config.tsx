...
const config: DocsThemeConfig = {
  ...
  project: {
    link: "https://github.com/khulnasoft/nextdev",
    icon: null,
  },
  darkMode: false,
  color: {
      ...
      <div className="flex !h-12 items-center md:gap-4 lg:-translate-x-4">
        ...
        <div className="relative">
          <Link
            ...
            href="https://github.com/khulnasoft/nextdev"
            target="_blank"
          >
            <svg
              className="size-4"
        ...
        <a
          href="https://discord.auth.khulnasoft.com/?utm_source=docs"
  ...
  head: () => {
    ...
    const url = `https://auth.khulnasoft.com${pathname}`
    ...
    return (
      <>
        ...
        <meta
          property="og:image"
          content={`https://auth.khulnasoft.com/api/og?title=${encodeURIComponent(
            title
          )}`}
        />
      </>
  ...
  docsRepositoryBase: "https://github.com/khulnasoft/nextdev/edit/main/docs",
  footer: {
    component: <Footer />,
  },
}
