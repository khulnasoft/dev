...
<div class="container">
  <p>
    ...
    with <a href="https://sveltekit.auth.khulnasoft.com">SvelteKit Auth</a> for authentication.
  </p>
        ...
        <div class="actions">
          <SignIn provider="github">
            <span slot="submitButton">
              <img
                src="https://auth.khulnasoft.com/img/providers/github.svg"
                alt="GitHub Logo"
                width="20"
                height="20"
              />
          ...
          <SignIn provider="discord">
            <span slot="submitButton">
              <img
                src="https://auth.khulnasoft.com/img/providers/discord.svg"
                alt="Discord Logo"
                width="20"
                height="20"
              />
