  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p>
        ...
        <CustomLink href="https://nextjs.auth.khulnasoft.com/react#usesession">
      ...
      <p>
        ...
        the{" "}
        <CustomLink href="https://nextjs.auth.khulnasoft.com/react#sessionprovider">
      ...
      <div className="flex flex-col gap-4 rounded-md bg-gray-100 p-4">
        ...
        <p>
          ...
          . Read more{" "}
          <CustomLink href="https://auth.khulnasoft.com/guides/integrating-third-party-backends">
            <code>here</code>
          </CustomLink>
        </p>
