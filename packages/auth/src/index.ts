/**
 * _If you are looking to migrate from v4, visit the [Upgrade Guide (v5)](https://auth.khulnasoft.com/getting-started/migrating-to-v5)._
 *
 * ## Installation
 *
 * ```bash npm2yarn
 ...
 *
 * :::tip
 * In production, `AUTH_SECRET` is a required environment variable - if not set, NextAuth.js will throw an error. See [MissingSecretError](https://auth.khulnasoft.com/reference/core/errors#missingsecret) for more details.
 * :::
 *
