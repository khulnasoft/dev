import { Auth, createActionURL, type AuthConfig } from "@nextauth.js/core"
...
import type { AuthAction, Awaitable, Session } from "@nextauth.js/core/types"
import type {
...
async function getSession(headers: Headers, config: NextAuthConfig) {
  ...
  return Auth(request, {
    ...
    callbacks: {
      ...
      // See https://auth.khulnasoft.com/getting-started/migrating-to-v5#authenticating-server-side
