 ...
 *
 * The callback URL used by the [providers](https://auth.khulnasoft.com/getting-started/providers) must be set to the following, unless you override {@link SvelteKitAuthConfig.basePath}:
 *
 * ```
