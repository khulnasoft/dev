...
export interface AdapterUser extends User {
  ...
  email: string
  /**
   * Whether the user has verified their email address via an [Email provider](https://auth.khulnasoft.com/getting-started/authentication/email).
 ...
 * - Email accounts, which are created when a user signs in with an [Email provider](https://auth.khulnasoft.com/getting-started/authentication/email).
 *
 ...
 * It is created when a user signs in with an [Email provider](https://auth.khulnasoft.com/getting-started/authentication/email).
...
export interface Adapter {
   ...
   *
   * See also [User management](https://auth.khulnasoft.com/guides/creating-a-database-adapter#user-management)
   */
   ...
   *
   * See also [Verification tokens](https://auth.khulnasoft.com/guides/creating-a-database-adapter#verification-tokens)
   */
   ...
   * It creates an [Account](https://auth.khulnasoft.com/reference/core/adapters#models) in the database.
   *
   * See also [User management](https://auth.khulnasoft.com/guides/creating-a-database-adapter#user-management)
   */
  linkAccount?(
   ...
   *
   * See also [Database Session management](https://auth.khulnasoft.com/guides/creating-a-database-adapter#database-session-management)
   */
