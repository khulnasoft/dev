 ...
 * @see https://auth.khulnasoft.com/reference/core/adapters#user
 ...
 * @see https://auth.khulnasoft.com/reference/core/adapters#account
 */
...
function normalizeEndpoint(
  ...
  // assert.ts. We fallback to "https://auth.khulnasoft.com" to be able to pass around
  // a valid URL even if the user only provided params.
  // NOTE: This need to be checked when constructing the URL
  // for the authorization, token and userinfo endpoints.
  const url = new URL(e?.url ?? "https://auth.khulnasoft.com")
  if (e?.params != null) {
