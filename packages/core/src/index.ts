 ...
 * Primarily used to implement [framework](https://auth.khulnasoft.com/getting-started/integrations)-specific packages,
 ...
 * })
 *```
 * @see [Documentation](https://auth.khulnasoft.com)
 */
export async function Auth(
  request: Request,
  config: AuthConfig
 ...
 * ```
 *
 * @see [Initialization](https://auth.khulnasoft.com/reference/core/types#authconfig)
 */
export interface AuthConfig {
  ...
  session?: {
     ...
     *
     * [Documentation](https://auth.khulnasoft.com/reference/core#authconfig#session) | [Adapter](https://auth.khulnasoft.com/reference/core#authconfig#adapter) | [About JSON Web Tokens](https://auth.khulnasoft.com/concepts/session-strategies#jwt-session)
     */
  ...
  callbacks?: {
     ...
     *
     * [`AccessDenied`](https://auth.khulnasoft.com/reference/core/errors#accessdenied)
     *
     * @example
     * ```ts
     * callbacks: {
     ...
     *
     * [Documentation](https://auth.khulnasoft.com/reference/core/types#redirect)
     *
     * @example
     * callbacks: {
     ...
     *
     * [`jwt` callback](https://auth.khulnasoft.com/reference/core/types#jwt)
     *
     * @example
     * ```ts
     * callbacks: {
     ...
     *
     * [`session` callback](https://auth.khulnasoft.com/reference/core/types#session)
     */
    jwt?: (params: {
      /**
       ...
       *
       * Resources:
       * - [Credentials Provider](https://auth.khulnasoft.com/getting-started/authentication/credentials)
       * - [User database model](https://auth.khulnasoft.com/guides/creating-a-database-adapter#user-management)
       */
      user: User | AdapterUser
      /**
   ...
   *
   * See also: [Guide: Securing a Preview Deployment](https://auth.khulnasoft.com/getting-started/deployment#securing-a-preview-deployment)
   */
