...
export class AuthError extends Error {
  ...
  constructor(
    ...
    const url = `https://errors.auth.khulnasoft.com#${this.type.toLowerCase()}`
...
/**
 * One of the database [`Adapter` methods](https://auth.khulnasoft.com/reference/core/adapters#methods)
...
/**
 * Thrown when the execution of the [`signIn` callback](https://auth.khulnasoft.com/reference/core/types#signin) fails
 ...
 * :::
 *
 * For an [OAuth provider](https://auth.khulnasoft.com/getting-started/authentication/oauth), possible causes are:
 ...
 *
 * For an [Email provider](https://auth.khulnasoft.com/getting-started/authentication/email), possible causes are:
 ...
 *
 * For a [Credentials provider](https://auth.khulnasoft.com/getting-started/authentication/credentials), possible causes are:
 ...
 *
 * Learn more at [Guide: Error pages](https://auth.khulnasoft.com/guides/pages/error)
 */
...
/**
 * One of the [`events` methods](https://auth.khulnasoft.com/reference/core/types#eventcallbacks)
 * failed during execution.
 *
 * Make sure that the `events` methods are implemented correctly and uncaught errors are handled.
 *
 * Learn more at [`events`](https://auth.khulnasoft.com/reference/core/types#eventcallbacks)
 */
 ...
 *
 * Learn more at [`OAuth2Config`](https://auth.khulnasoft.com/reference/core/providers#oauth2configprofile) or [Guide: OAuth Provider](https://auth.khulnasoft.com/guides/configuring-oauth-providers)
 */
 ...
 *
 * Learn more at [`checks`](https://auth.khulnasoft.com/reference/core/providers#checks)
 */
 ...
 * :::
 *
 * Learn more at [`secret`](https://auth.khulnasoft.com/reference/core#secret), [`jwt.encode`](https://auth.khulnasoft.com/reference/core/jwt#encode-1) or [`jwt.decode`](https://auth.khulnasoft.com/reference/core/jwt#decode-2) for more information.
 */
 ...
 *
 * Learn more at [Database Adapters](https://auth.khulnasoft.com/getting-started/database), [Email provider](https://auth.khulnasoft.com/getting-started/authentication/email) or [Concept: Database session strategy](https://auth.khulnasoft.com/concepts/session-strategies#database-session)
 */
...
/**
 * Thrown similarily to [`MissingAdapter`](https://auth.khulnasoft.com/reference/core/errors#missingadapter), but only some required methods were missing.
 *
 * Make sure you either remove the configuration or add the missing methods to the adapter.
 *
 * Learn more at [Database Adapters](https://auth.khulnasoft.com/getting-started/database)
 */
 ...
 *
 * Learn more at [Credentials provider](https://auth.khulnasoft.com/getting-started/authentication/credentials)
 */
 ...
 * Alternatively, you can also explicitly set the [`AuthConfig.secret`](https://auth.khulnasoft.com/reference/core#secret) option.
 * :::
 *
 *
 * :::tip
 ...
 * you can enable automatic account linking by setting [`allowDangerousEmailAccountLinking: true`](https://auth.khulnasoft.com/reference/core/providers#allowdangerousemailaccountlinking)
 ...
 * changed, or the [`OAuth2Config.profile`](https://auth.khulnasoft.com/reference/core/providers#oauth2configprofile) method is not implemented correctly.
 */
 ...
 *
 * Learn more at [Concept: Database session strategy](https://auth.khulnasoft.com/concepts/session-strategies#database)
 */
...
/**
 * Happens when login by [OAuth](https://auth.khulnasoft.com/getting-started/authentication/oauth) could not be started.
 *
 * Possible causes are:
...
/**
 * Happens when the login by an [Email provider](https://auth.khulnasoft.com/getting-started/authentication/email) could not be started.
 *
 * Possible causes are:
 * - The email sent from the client is invalid, could not be normalized by [`EmailConfig.normalizeIdentifier`](https://auth.khulnasoft.com/reference/core/providers/email#normalizeidentifier)
 * - The provided email/token combination has expired:
 *   Ask the user to log in again.
 * - There was an error with the database:
 *   Check the database logs.
 ...
 *
 * Learn more at [`strategy`](https://auth.khulnasoft.com/reference/core#strategy) or [Credentials provider](https://auth.khulnasoft.com/getting-started/authentication/credentials)
 */
