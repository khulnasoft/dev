 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/slack.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Slack provider is
 ...
 * :::tip
 *
 * The Slack provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/slack.ts).
