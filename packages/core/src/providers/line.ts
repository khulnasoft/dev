 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/line.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import LINE from "@nextauth.js/core/providers/line"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the LINE provider is
 ...
 * :::tip
 *
 * The LINE provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/line.ts).
