 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/trakt.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * import Trakt from "@nextauth.js/core/providers/trakt"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Trakt provider is
 ...
 * :::tip
 *
 * The Trakt provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/trakt.ts).
