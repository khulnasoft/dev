 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/box.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import Box from "@nextauth.js/core/providers/box"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Box provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The Box provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/box.ts).
