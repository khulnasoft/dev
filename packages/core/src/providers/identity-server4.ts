 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/identity-server4.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import IdentityServer4 from "@nextauth.js/core/providers/identity-server4"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the IdentityServer4 provider is
 ...
 * :::tip
 *
 * The IdentityServer4 provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/identity-server4.ts).
