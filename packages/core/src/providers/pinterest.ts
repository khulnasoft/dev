 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/pinterest.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Pinterest provider is
 ...
 * :::tip
 *
 * The Pinterest provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/pinterest.ts).
