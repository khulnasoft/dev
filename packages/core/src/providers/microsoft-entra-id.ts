 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/microsoft-entra-id.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * :::tip
 *
 * The Microsoft Entra ID provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/microsoft-entra-id.ts).
