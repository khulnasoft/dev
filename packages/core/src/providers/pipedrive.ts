 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/pipedrive.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * import Pipedrive from "@nextauth.js/core/providers/pipedrive"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Pipedrive provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The Pipedrive provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/pipedrive.ts).
