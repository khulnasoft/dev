 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/osso.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * import Osso from "@nextauth.js/core/providers/osso"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Osso provider is
 ...
 * :::tip
 *
 * The Osso provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/osso.ts).
