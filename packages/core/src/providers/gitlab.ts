 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/gitlab.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the GitLab provider is
 ...
 * :::tip
 *
 * The GitLab provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/gitlab.ts).
