 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/nextcloud.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import Nextcloud from "@nextauth.js/core/providers/nextcloud"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Nextcloud provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The Nextcloud provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/nextcloud.ts).
