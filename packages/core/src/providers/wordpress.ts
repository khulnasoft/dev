 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/wordpress.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * :::tip
 *
 * The WordPress provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/wordpress.ts).
