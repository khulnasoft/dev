 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/ory.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * import OryHydra from "@nextauth.js/core/providers/ory-hydra"
 *
 ...
 * infrastructure.
 * By default, NextAuth.js assumes that the Ory Hydra provider is
 * based on the [Open ID Connect](https://openid.net/specs/openid-connect-core-1_0.html) specification.
 *
 * :::tip
 *
 * The Ory Hydra provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/ory-hydra.ts).
