 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/eveonline.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import EveOnline from "@nextauth.js/core/providers/eveonline"
 *
 ...
 * ```
 * :::
 * By default, NextAuth.js assumes that the EveOnline provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The EveOnline provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/eveonline.ts).
