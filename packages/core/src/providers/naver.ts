 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/naver.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import Naver from "@nextauth.js/core/providers/naver"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Naver provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The Naver provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/naver.ts).
