 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/medium.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import Medium from "@nextauth.js/core/providers/medium"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Medium provider is
 ...
 * :::tip
 *
 * The Medium provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/medium.ts).
