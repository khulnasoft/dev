 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/coinbase.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * :::tip
 *
 * The Coinbase provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/coinbase.ts).
