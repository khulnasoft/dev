 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/tiktok.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * import TikTok from "@nextauth.js/core/providers/tiktok"
 *
 ...
 * :::
 *
 * By default, NextAuth.js assumes that the TikTok provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The TikTok provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/tiktok.ts).
