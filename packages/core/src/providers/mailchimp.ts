 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/mailchimp.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import Mailchimp from "@nextauth.js/core/providers/mailchimp"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Mailchimp provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The Mailchimp provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/mailchimp.ts).
