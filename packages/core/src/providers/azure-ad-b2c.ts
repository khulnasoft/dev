 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/azure.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import AzureADB2C from "@nextauth.js/core/providers/azure-ad-b2c"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Azure AD B2C provider is
 * based on the [OIDC](https://openid.net/specs/openid-connect-core-1_0.html) specification.
 *
 * :::tip
 *
 * The Azure AD B2C provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/azure-ad-b2c.ts).
