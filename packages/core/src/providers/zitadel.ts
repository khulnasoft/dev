 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/zitadel.svg" height="48"/>
 * </a>
 * </div>
 *
 ...
 * import ZITADEL from "@nextauth.js/core/providers/zitadel"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the ZITADEL provider is
 ...
 * :::tip
 *
 * The ZITADEL provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/zitadel.ts).
