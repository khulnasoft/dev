 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/faceit.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import FACEIT from "@nextauth.js/core/providers/faceit"
 *
 ...
 * By default, NextAuth.js assumes that the FACEIT provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The FACEIT provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/faceit.ts).
