 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/notion.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * :::tip
 *
 * The Notion provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/notion.ts).
...
export default function NotionProvider<P extends NotionProfile>(
  ...
  return {
    ...
    userinfo: {
      ...
      // More info: https://auth.khulnasoft.com/getting-started/providers/notion
