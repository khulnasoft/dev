 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/duende-identity-server6.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import DuendeIdentityServer6 from "@nextauth.js/core/providers/duende-identity-server6"
 *
 ...
 * ]
 * ```
 * By default, NextAuth.js assumes that the DuendeIdentityServer6 provider is
 * based on the [Open ID Connect](https://openid.net/specs/openid-connect-core-1_0.html) specification.
 *
 * :::tip
 *
 * The DuendeIdentityServer6 provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/duende-identity-server6.ts).
