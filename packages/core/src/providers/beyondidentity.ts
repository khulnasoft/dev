 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/beyondidentity.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import BeyondIdentity from "@nextauth.js/core/providers/beyondidentity"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the BeyondIdentity provider is
 * based on the [OIDC](https://openid.net/specs/openid-connect-core-1_0.html) specification.
 *
 * :::tip
 *
 * The BeyondIdentity provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/beyondidentity.ts).
