 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/cognito.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * :::
 *
 * By default, NextAuth.js assumes that the Cognito provider is
 * based on the [Open ID Connect](https://openid.net/specs/openid-connect-core-1_0.html) specification.
 *
 * :::tip
 *
 * The Cognito provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/cognito.ts).
