 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/hubspot.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the HubSpot provider is
 ...
 * :::tip
 *
 * The HubSpot provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/hubspot.ts).
