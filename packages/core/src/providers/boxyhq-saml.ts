 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/boxyhq-saml.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import BoxyHQ from "@nextauth.js/core/providers/boxyhq-saml"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the BoxyHQ provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The BoxyHQ provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/boxyhq-saml.ts).
