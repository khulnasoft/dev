 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/bungie.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import Bungie from "@nextauth.js/core/providers/bungie"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Bungie provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The Bungie provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/bungie.ts).
