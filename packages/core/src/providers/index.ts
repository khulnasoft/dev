 ...
 * @see [Email or Passwordless Authentication](https://auth.khulnasoft.com/concepts/oauth)
 * @see [Credentials-based Authentication](https://auth.khulnasoft.com/concepts/credentials)
 */
 ...
 *
 * @see [OAuth/OIDC guide](https://auth.khulnasoft.com/guides/providers/custom-provider)
 * @see [Email (Passwordless) guide](https://auth.khulnasoft.com/guides/providers/email)
 * @see [Credentials guide](https://auth.khulnasoft.com/guides/providers/credentials)
 */
