 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/battlenet.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import BattleNet from "@nextauth.js/core/providers/battlenet"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the BattleNet provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The BattleNet provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/battlenet.ts).
