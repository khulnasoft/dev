 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/todoist.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * import Todoist from "@nextauth.js/core/providers/todoist"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Todoist provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The Todoist provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/todoist.ts).
