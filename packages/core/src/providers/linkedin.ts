 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/linkedin.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * :::tip
 *
 * The LinkedIn provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/linkedin.ts).
