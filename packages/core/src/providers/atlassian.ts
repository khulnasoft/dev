 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/atlassian.svg" width="24" style={{ marginTop: "-3px"}} />
 * </a>
 * </div>
 *
 ...
 * #### Configuration
 *
 * Import the provider and configure it in your **NextAuth.js** initialization file:
 *
 * ```ts
 * import Atlassian from "@nextauth.js/core/providers/atlassian"
 * ...
 * providers: [
 *  Atlassian({
 ...
 * ### Notes
 *
 * The Atlassian provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/atlassian.ts). To override the defaults for your use case, check out [customizing a built-in OAuth provider](https://auth.khulnasoft.com/guides/providers/custom-provider#override-default-options).
 *
 * ## Help
 *
