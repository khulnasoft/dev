 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/bankid-no.svg" width="24"/>
 * </a>
 * </div>
 *
 ...
 * import BankIDNorge from "@nextauth.js/core/providers/bankid-no"
 *
 ...
 * ### Notes
 *
 * The BankID Norge provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/bankid-no.ts). To override the defaults for your use case, check out [customizing a built-in OAuth provider](https://auth.khulnasoft.com/guides/configuring-oauth-providers).
 *
 * ## Help
 *
