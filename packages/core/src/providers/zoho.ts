 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/zoho.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * import ZOHO from "@nextauth.js/core/providers/zoho"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the ZOHO provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The ZOHO provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/zoho.ts).
