 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/webex.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import Webex from "@nextauth.js/core/providers/webex"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Webex provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The Webex provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/webex.ts).
