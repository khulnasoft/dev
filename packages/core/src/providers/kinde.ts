 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/kinde.svg" width="24"/>
 * </a>
 * </div>
 *
 ...
 * ### Notes
 *
 * The Kinde provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/kinde.ts). To override the defaults for your use case, check out [customizing a built-in OAuth provider](https://auth.khulnasoft.com/guides/configuring-oauth-providers).
 *
 * ## Help
 *
