 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/patreon.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * import Patreon from "@nextauth.js/core/providers/patreon"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Patreon provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The Patreon provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/patreon.ts).
