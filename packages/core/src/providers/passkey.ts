 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/passkey.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import Passkey from "@nextauth.js/core/providers/passkey"
 *
 ...
 * - [Source code](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/passkey.ts)
 *
 * ### Notes
 *
 ...
 * :::tip
 *
 * The Passkey provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/passkey.ts).
 * To override the defaults for your use case, check out [customizing a built-in WebAuthn provider](https://auth.khulnasoft.com/guides/configuring-oauth-providers).
 *
 * :::
 *
 * :::info **Disclaimer**
