 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/threads.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * import Threads from "@nextauth.js/core/providers/threads"
 *
 ...
 * :::
 *
 * By default, NextAuth.js assumes that the Threads provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The Threads provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/threads.ts).
