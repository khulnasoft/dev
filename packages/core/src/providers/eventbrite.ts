 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/eventbrite.svg" height="48" width="48"/>
 * </a>
 * </div>
 *
 ...
 * import Eventbrite from "@nextauth.js/core/providers/eventbrite"
 *
 ...
 * - [Source code](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/eventbrite.ts)
 *
 * ### Notes
 *
 * By default, NextAuth.js assumes that the Eventbrite provider is
 * based on the [OAuth 2](https://www.rfc-editor.org/rfc/rfc6749.html) specification.
 *
 * :::tip
 *
 * The Eventbrite provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/eventbrite.ts).
