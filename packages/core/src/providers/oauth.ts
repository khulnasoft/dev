...
export interface OAuth2Config<Profile>
   ...
   *
   * @see [Database Adapter: User model](https://auth.khulnasoft.com/reference/core/adapters#user)
   */
   ...
   *
   * :::note
   * You need to adjust your database's [Account model](https://auth.khulnasoft.com/reference/core/adapters#account) to match the returned properties.
   * Check out the documentation of your [database adapter](https://auth.khulnasoft.com/reference/core/adapters) for more information.
   * :::
   *
   ...
   * ```
   *
   * @see [Database Adapter: Account model](https://auth.khulnasoft.com/reference/core/adapters#account)
   ...
   * Learn more in our [Security FAQ](https://auth.khulnasoft.com/concepts#security).
   *
