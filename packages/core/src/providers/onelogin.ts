 ...
 *   <img style={{display: "block"}} src="https://auth.khulnasoft.com/img/providers/onelogin.svg" height="48" />
 * </a>
 * </div>
 *
 ...
 * import OneLogin from "@nextauth.js/core/providers/onelogin"
 *
 ...
 * ### Notes
 *
 * By default, NextAuth.js assumes that the OneLogin provider is
 * based on the [Open ID Connect](https://openid.net/specs/openid-connect-core-1_0.html) specification.
 *
 * :::tip
 *
 * The OneLogin provider comes with a [default configuration](https://github.com/khulnasoft/nextdev/blob/main/packages/core/src/providers/onelogin.ts).
