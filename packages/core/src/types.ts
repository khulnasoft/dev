 ...
 * - [Extending built-in types](https://auth.khulnasoft.com/getting-started/typescript#module-augmentation)
 *
 * @module types
 */
 ...
 *
 * [Documentation](https://auth.khulnasoft.com/reference/core#theme) |
 * [Pages](https://auth.khulnasoft.com/guides/pages/signin)
 */
...
export interface Account extends Partial<TokenEndpointResponse> {
  /** Provider's id for this account. E.g. "google". See the full list at https://auth.khulnasoft.com/reference/core/providers */
  provider: string
  /**
   ...
   *
   * @see https://auth.khulnasoft.com/reference/core/adapters#adapteruser
   */
  userId?: string
  /**
   ...
   *
   * @see https://auth.khulnasoft.com/guides/refresh-token-rotation#database-strategy
...
/** [Documentation](https://auth.khulnasoft.com/reference/core#cookies) */
 ...
 *
 * - **`"callback"`**:
 *   - **`GET`**: Handles the callback from an [OAuth provider](https://auth.khulnasoft.com/reference/core/providers#oauth2configprofile).
 *   - **`POST`**: Handles the callback from a [Credentials provider](https://auth.khulnasoft.com/getting-started/providers/credentials#credentialsconfigcredentialsinputs).
 ...
 * :::note
 * Some frameworks have built-in CSRF protection and can therefore disable this action. In this case, the corresponding endpoint will return a 404 response. Read more at [`skipCSRFCheck`](https://auth.khulnasoft.com/reference/core#skipcsrfcheck).
...
export interface InternalOptions<TProviderType = ProviderType> {
   ...
   * or [`skipCSRFCheck`](https://auth.khulnasoft.com/reference/core#skipcsrfcheck) was enabled.
   */
