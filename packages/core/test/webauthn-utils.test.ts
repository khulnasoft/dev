...
describe("verifyAuthenticate", () => {
  ...
  it("errors on invalid request body", async () => {
    ...
    await expect(() =>
      ...
      `[AuthError: Invalid WebAuthn Authentication response. Read more at https://errors.auth.khulnasoft.com#autherror]`
    )
  ...
  it("errors on invalid authenticator", async () => {
    ...
    await expect(() =>
      ...
      `[AuthError: WebAuthn authenticator not found in database: {"credentialID":"AQIDBAU="}. Read more at https://errors.auth.khulnasoft.com#autherror]`
    )
  ...
  it("errors if account does not exist", async () => {
    ...
    await expect(() =>
      ...
      `[AuthError: WebAuthn account not found in database: {"credentialID":"AQIDBAU=","providerAccountId":"AQIDBAU="}. Read more at https://errors.auth.khulnasoft.com#autherror]`
    )
...
describe("verifyRegister", () => {
  ...
  it("fails on invalid request body", async () => {
    ...
    await expect(() =>
      ...
      `[AuthError: Invalid WebAuthn Registration response. Read more at https://errors.auth.khulnasoft.com#autherror]`
    )
  ...
  it("errors on missing registration data in challenge cookie", async () => {
    ...
    await expect(() =>
      ...
      `[AuthError: Missing user registration data in WebAuthn challenge cookie. Read more at https://errors.auth.khulnasoft.com#autherror]`
    )
