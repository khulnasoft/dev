 ...
 * The callback URL used by the [providers](https://auth.khulnasoft.com/reference/core/providers) must be set to the following, unless you mount the `ExpressAuth` handler on a different path:
 *
 * ```
 ...
 * Once your application is mounted you can sign in or out by making requests to the following [REST API endpoints](https://auth.khulnasoft.com/reference/core/types#authaction) from your client-side code.
