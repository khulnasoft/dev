...
export interface DgraphAdapterOptions {
   ...
   *
   * By default the adapter will uses the [default defined fragments](https://github.com/khulnasoft/nextdev/blob/main/packages/adapter-dgraph/src/lib/graphql/fragments.ts)
